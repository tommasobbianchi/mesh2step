...
nsol = 0; exs = TopExp_Explorer(back, TopAbs_SOLID)
while exs.More(): nsol += 1; exs.Next()
print("STEP %s; re-read valid %s solids %d type %s" % (ok, BRepCheck_Analyzer(back, True).IsValid(), nsol, back.ShapeType()), flush=True)
